...
import 'package:flutter_calculator_app/calculator_button.dart';
import 'package:flutter_calculator_app/result_display.dart';
      ...
      children: [
        ...
        Row(
          children: [
            ...
            _getButton(text: 'x', onTap: () => operatorPressed('*'))
          ],
        ),
        Row(
          children: [
        ...
        Row(
          children: [
            ...
            _getButton(
                text: 'C',
                onTap: clear,
                backgroundColor: Color.fromARGB(220, 220, 220, 1)),
            _getButton(
                text: '-',
